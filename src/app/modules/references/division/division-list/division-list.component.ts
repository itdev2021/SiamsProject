...
import { DivisionEntryComponent } from '../division-entry/division-entry.component';
...
export class DivisionComponent implements OnInit {
  ...
  constructor(private service: DivisionService,
    ...
    displayedColumns: string[] = ['DivisionID','Division','actions'];
  ...
  onAdd(){
    ...
    const dialogRef = this.dialog.open(DivisionEntryComponent, dialogconfig);
  ...
  onEdit(row: number){
    this.service.getByID(row).subscribe(data => {
      this.service.formDivision.patchValue({
