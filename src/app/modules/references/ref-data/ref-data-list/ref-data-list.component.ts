...
export class RefDataComponent implements OnInit {
  ...
  onAdd(){
    ...
    const dialogRef = this.dialog.open(RefDataEntryComponent, dialogconfig);
  ...
  onEdit(row: number){
    this.service.getByID(row).subscribe(data => {
      this.service.formRefData.patchValue({
        id: data.id,
