...
import { TherapeuticEntryComponent } from '../therapeutic-entry/therapeutic-entry.component';
...
export class TherapeuticComponent implements OnInit {
  ...
  constructor(private service: TherapeuticService,
    private dialog: MatDialog,
    private notificationService: NotificationService,
    private comfirmDialogService: ConfirmDialogService) { }

  dataSource: MatTableDataSource<any>;
  displayedColumns: string[] = ['TherapeuticID', 'Description', 'actions'];
  ...
  onAdd() {
    ...
    const dialogRef = this.dialog.open(TherapeuticEntryComponent, dialogconfig);
  ...
  onEdit(row: number) {
    this.service.getByID(row).subscribe(data => {
      this.service.formTherapeutic.patchValue({
